...
% stiffness matrix. 
%--------------------------------------------------------------------------
function [T_internal,geomJn_1,VolRate,f_damp] = ...
          InternalForce_parallel(ielement,FEM,xlocal,x0local,...
          Ve,QUAD,properties,CONSTANT,GEOM,...
          PLAST,matyp,KINEMATICS,DN_X,MAT,DAMPING,VolumeCorrect,dt)
