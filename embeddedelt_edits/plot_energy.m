...
file=fopen('C:/Users/Valerie/Documents/GitHub/flagshyp/embeddedelt_edits/job_folder/embed_1h_25t/energy.dat','r');
formatSpec = '%e %e %e %e';
sizeA = [4 inf ];
...
%explicit_embedded_4elt_new
file=fopen('C:/Users/Valerie/Documents/GitHub/flagshyp/embeddedelt_edits/job_folder/embed_1h_25t_correct/energy.dat','r');
formatSpec = '%e %e %e %e';
sizeA = [4 inf ];
A = fscanf(file,formatSpec,sizeA);
fclose(file);
