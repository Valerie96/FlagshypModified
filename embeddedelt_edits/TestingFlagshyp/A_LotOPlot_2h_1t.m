...
AbqOneHost  = ReadAbaqus_2h_0t('Flagshyp_2h_0t');
...
FLAG_3 = ReadFlagshypOutputFile(file3,'jf', 83,1);
% 
% AbqOneHost  = ReadAbaqus_2h_0t('Flagshyp_2h_0t_Force');
% [AbqEHost, AbqETruss, AbqE] = ReadAbaqus_xh_yt('Flagshyp_2h_1t_Force',2,1);
% 
% graphsize=[100 100 800 400];
% name1a = "Abaqus Solid";
% name2a = "Abaqus Embedded";
