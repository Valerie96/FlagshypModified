...
n_outputs = n_outputs - 1; %Should change this but works for now
%%
%Get energy data. Easy
Energy = cell2mat(C(4:4+n_outputs,1:12));
C(1:4+n_outputs+4,:) = [];
    AbqE.time = Energy(:,1);
    AbqE.AE = Energy(:,2);
    % AbqE.CD = Energy(:,3);
