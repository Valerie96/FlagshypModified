...
[AbqEHost, AbqETruss, AbqE] = ReadAbaqus_xh_yt('Flagshyp_4h_2t_butonly1elementofeach',1,1);
...
AbqOneHost  = ReadAbaqus_1h_0t('Flagshyp_4h_0t_butonly1elementofeach');
[AbqEHost, AbqETruss, AbqE] = ReadAbaqus_xh_yt('Flagshyp_4h_2t_butonly1elementofeach',1,1);

graphsize=[100 100 800 400];
name1a = "Abaqus Solid 4h";
name2a = "Abaqus Embedded";

file1="embed_4h_0t";
name1 = "Flagshyp 4h No Truss";

file2="embed_4h_2t";
name2 = "Flagshyp 4h 2t";

file3="embed_4h_2t_correct";
name3 = "Flagshyp 4h 2t corrected";

FLAG_1 = ReadFlagshypOutputFile(file1,'jf', 83,1); 
FLAG_2 = ReadFlagshypOutputFile(file2,'jf', 163,1);
FLAG_3 = ReadFlagshypOutputFile(file3,'jf', 163,1);
