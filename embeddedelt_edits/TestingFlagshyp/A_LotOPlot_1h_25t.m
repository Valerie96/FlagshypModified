...
[AbqEHost, AbqETruss, AbqE] = ReadAbaqus_xh_yt('Flagshyp_1h_25t',1,25);
...
plot(AbqE.time,AbqEHost.Force,'ro' ,'DisplayName',name2a);
...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(AbqE.time,AbqETruss.Displacement(:,1),'ro' ,'DisplayName',name2a);
plot(FLAG_2.time,FLAG_2.Disp(:,1,10),'r','DisplayName',name2,'LineWidth',3);
plot(FLAG_3.time,FLAG_3.Disp(:,1,10),'g','DisplayName',name3,'LineWidth',2);
title("X Disp");
xlabel("Time (s)");
ylabel("Displacement (m) ");
legend('show');
...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(AbqE.time,AbqETruss.Vel(:,1),'ro' ,'DisplayName',name2a);
plot(FLAG_2.time,FLAG_2.Vel(:,1,10),'r','DisplayName',name2,'LineWidth',3);
plot(FLAG_3.time,FLAG_3.Vel(:,1,10),'g','DisplayName',name3,'LineWidth',2);
title("X Velocity");
xlabel("Time (s)");
ylabel("Velocity (m/s) ");
legend('show');
