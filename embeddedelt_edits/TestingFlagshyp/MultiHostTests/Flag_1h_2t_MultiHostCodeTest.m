...
file2="embed_1h_10t_correct";
name2 = "Flagshyp Original";

file3="embed_1h_2t_correct_new";
name3 = "Flagshyp MultiHostFunction";
...
plot(FLAG_2.time,FLAG_2.Acc(:,1,1),'DisplayName',name2,'LineWidth',1);
