...
[AbqEHost, AbqETruss, AbqE] = ReadAbaqus_xh_yt('Flagshyp_1h_2t',1,2);
...
file2="embed_1h_2t";
name2 = "Flagshyp 1h 2t";

file3="embed_1h_2t_correct";
name3 = "Flagshyp 1h 2t Corrected";
...
IEerror_2t = abs(AbqE.IE(end) - FLAG_2.IE(end))/AbqE.IE(end);
IEerror_2tc = abs(AbqOneHost.IE(end) - FLAG_3.IE(end))/AbqOneHost.IE(end);
